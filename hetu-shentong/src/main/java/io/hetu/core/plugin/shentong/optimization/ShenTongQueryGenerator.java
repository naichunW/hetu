...
public class ShenTongQueryGenerator
        extends BaseJdbcQueryGenerator {
    public ShenTongQueryGenerator(DeterminismEvaluator determinismEvaluator,
        ...
        super(
                pushDownParameter,
                new ShenTongRowExpressionConverter(determinismEvaluator, rowExpressionService, functionManager, functionResolution,baseConfig),
                new ShenTongSqlStatementWriter(pushDownParameter));
    }
}
