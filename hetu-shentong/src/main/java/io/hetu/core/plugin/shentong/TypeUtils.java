...
import static io.prestosql.spi.type.Decimals.*;
...
public final class TypeUtils
{
    ...
    public static String getArrayElementPgTypeName(ConnectorSession session, ShenTongSqlClient client, Type elementType)
    {
